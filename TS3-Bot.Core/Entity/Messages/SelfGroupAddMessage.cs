namespace DirkSarodnick.TS3_Bot.Core.Entity.Messages
{
    ...
    /// <summary>
    /// Defines SelfGroupAddMessage class.
    /// </summary>
    public class SelfGroupAddMessage : Message
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SelfGroupAddMessage"/> class.
        /// </summary>
        public SelfGroupAddMessage()
        {
        }
        ...
        protected override string Command { get { return this.Repository.Settings.Control.SelfGroup.Command; } }
        ...
        /// The not command.
        /// </value>
        protected string NotCommand { get { return this.Repository.Settings.Control.SelfGroup.UndoCommand; } }
        ...
        public override bool Validate(string[] parameters)
        {
            return parameters.Length > 1 &&
                   ...
                   !string.Join(" ", parameters).StartsWith(NotCommand, StringComparison.InvariantCultureIgnoreCase) &&
