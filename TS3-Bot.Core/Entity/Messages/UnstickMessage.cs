namespace DirkSarodnick.TS3_Bot.Core.Entity.Messages
{
    ...
    /// <summary>
    /// Defines UnstickMessage class.
    /// </summary>
    public class UnstickMessage : Message
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnstickMessage"/> class.
        /// </summary>
        public UnstickMessage()
        {
        ...
        protected override string Command { get { return this.Repository.Settings.Control.Stick.UndoCommand; } }
